!(function (e, t) {
    ...
    const V = { previousBodyPadding: null },
        ...
        re = (e) => {
            ...
            if (ie()) r("SweetAlert2 requires document to initialize");
                ...
                o.appendChild(n),
                    ...
                    (e = o),
                    "rtl" === window.getComputedStyle(e).direction && _(f(), g.rtl),
                    (() => {
                        const e = w(),
                            t = Y(e, g.input),
                            n = Y(e, g.file),
        ...
        pe = (e, t) => {
            ...
            var o = T(),
                ...
                a = S(),
                s = L();
            t.showConfirmButton || t.showDenyButton || t.showCancelButton || $(n),
                F(n, t, "actions"),
                me(i, "confirm", t),
                me(a, "deny", t),
                me(s, "cancel", t),
    ...
    const he = (e, t) => {
        ...
        i &&
            ((o = i),
                "string" == typeof (n = t.backdrop) ? (o.style.background = n) : n || _([document.documentElement, document.body], g["no-backdrop"]),
                !t.backdrop && t.allowOutsideClick && s('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                (o = i),
                (n = t.position) in g ? _(o, g[n]) : (s('The "position" parameter is not valid, defaulting to "center"'), _(o, g.center)),
                (n = i),
                !(o = t.grow) || "string" != typeof o || ((o = "grow-".concat(o)) in g && _(n, g[o])),
                F(i, t, "container"));
    };
    ...
    const be = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        Ae = {};
    (Ae.text = Ae.email = Ae.password = Ae.number = Ae.tel = Ae.url = (e, t) => (
        "string" == typeof t.inputValue || "number" == typeof t.inputValue ? (e.value = t.inputValue) : m(t.inputValue) || s('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')),
        Ce(e, e, t),
        we(e, t),
        (e.type = t.input),
        e
    ...
    const Be = (e, t) => {
        const n = A();
        F(n, t, "htmlContainer"),
            t.html ? (ce(t.html, n), J(n, "block")) : t.text ? ((n.textContent = t.text), J(n, "block")) : $(n),
            ((e, o) => {
                const i = w();
        ...
        Le = (e, o) => {
            ...
            J(i),
                ...
                o.progressSteps.forEach((e, t) => {
                    var n,
                        e = ((n = e), (e = document.createElement("li")), _(e, g["progress-step"]), N(e, n), e);
                    i.appendChild(e),
                        t === o.currentProgressStep && _(e, g["active-progress-step"]),
        ...
        Oe = (e, t) => {
            (e.className = "".concat(g.popup, " ").concat(Q(e) ? t.showClass.popup : "")),
                t.toast ? (_([document.documentElement, document.body], g["toast-shown"]), _(e, g.toast)) : _(e, g.modal),
                F(e, t, "popup"),
                ...
                o && n.icon === o.icon
                    ...
                    : n.icon || n.iconHtml
                        ? n.icon && -1 === Object.keys(b).indexOf(n.icon)
                            ? (r('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(n.icon, '"')), $(i))
    ...
    function at(e, t, n, o) {
        H() ? ct(e, o) : (He(n).then(() => ct(e, o)), qe.keydownTarget.removeEventListener("keydown", qe.keydownHandler, { capture: qe.keydownListenerCapture }), (qe.keydownHandlerAdded = !1)),
            ...
            (null !== V.previousBodyPadding && ((document.body.style.paddingRight = "".concat(V.previousBodyPadding, "px")), (V.previousBodyPadding = null)),
                U(document.body, g.iosfix) && ((t = parseInt(document.body.style.top, 10)), K(document.body, g.iosfix), (document.body.style.top = ""), (document.body.scrollTop = -1 * t)),
                (() => {
    ...
    const ht = ["swal-title", "swal-html", "swal-footer"],
        ...
        Bt = (e) => {
            ...
            St(t, n, e),
                ...
                H() || qe.previousActiveElement || (qe.previousActiveElement = document.activeElement),
        ...
        Et = (e, t, n) => {
            ...
            ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) || ("MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints)) &&
                ...
                ((o = document.body.scrollTop), (document.body.style.top = "".concat(-1 * o, "px")), _(document.body, g.iosfix), et(), Qe()),
                t && "hidden" !== n && Ge(),
                setTimeout(() => {
                    e.scrollTop = 0;
                });
        ...
        St = (e, t, n) => {
            _(e, n.showClass.backdrop),
                ...
                n.heightAuto && n.backdrop && !n.toast && _([document.documentElement, document.body], g["height-auto"]);
        },
        Tt = (e) => (e.checked ? 1 : 0),
    ...
    e = Object.freeze({
        ...
        _main: function (e, t = {}) {
            ...
            var s,
                ...
                c,
                t = ((e) => {
                    const t = { popup: w(), container: f(), actions: O(), confirmButton: E(), denyButton: S(), cancelButton: L(), loader: T(), closeButton: M(), validationMessage: P(), progressSteps: x() };
            ...
            return (
                ...
                new Promise((e) => {
                    ...
                    it.swalPromiseResolve.set(s, e),
                        ...
                        (a = r),
                        (e = t),
                        ge.innerParams.get(n).toast ? $t(n, a, e) : (Gt(a), Qt(a), en(n, a, e)),
                        (o = s),
                        (a = qe),
                        (e = c),
                        (i = t),
                        ...
                        ((a.keydownHandler = (e) => _t(o, e, i)),
                            (a.keydownTarget = e.keydownListenerCapture ? window : w()),
                        ...
                        (e = s),
                        "select" === (a = c).input || "radio" === a.input ? jt(e, a) : ["text", "email", "number", "tel", "textarea"].includes(a.input) && (d(a.inputValue) || m(a.inputValue)) && It(e, a),
                        Bt(c),
                        tn(qe, c, t),
                        nn(r, c),
                        setTimeout(() => {
        ...
        _destroy: function () {
            ...
            t &&
                (e.popup && qe.swalCloseEventFinishedCallback && (qe.swalCloseEventFinishedCallback(), delete qe.swalCloseEventFinishedCallback),
                    qe.deferDisposalTimer && (clearTimeout(qe.deferDisposalTimer), delete qe.deferDisposalTimer),
                    c(t.didDestroy),
                    delete this.params,
